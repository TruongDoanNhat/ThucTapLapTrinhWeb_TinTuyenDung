...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/tro-giup.css">
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="bang-tin.jsp" >
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="bang-tin.jsp">
            ...
            <li class="nav-item">
                <a class="nav-link" href="quan-li-cv.jsp">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="thong-bao-he-thong.jsp">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link   " href="tai-khoan.jsp">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="tro-giup.jsp"  class="btn btn-white btn-sm w-100 mb-0">Tư vấn viên</a>
                </div>
            </div>
        </div>
        <a class="btn bg-gradient-primary mt-3 w-100"
           href="cap-nhat-thong-tin-xac-thuc.jsp">Nâng cấp tài khoản</a>
    </div>
</aside>
<!--  end nav left -->
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Trợ giúp
                    </li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Trợ giúp</h6>
            </nav>
                ...
                <ul class="navbar-nav  justify-content-end">
                    <li class="nav-item d-flex align-items-center">
                        ...
                        <a class="btn btn-outline-primary btn-sm mb-0 me-3"
                           href="dang-tin.jsp">Đăng tin</a>
                        <a class="btn btn-outline-primary btn-sm mb-0 me-3"
                           href="quan-li-cv.jsp">Xem CV</a>
                        <a class="btn btn-outline-primary btn-sm mb-0 me-3 active"
                           href="tro-giup.jsp">Trợ giúp</a>
                    </li>
        ...
        <div data-v-7dd9989e="" class="help-box show">
            <div data-v-7dd9989e="" class="header">
                <div data-v-7dd9989e="" class="greeting flex-m mb-1">
                    ...
                    <div data-v-7dd9989e="">Xin chào phuoc</div>
                </div>
            ...
            <div data-v-7dd9989e="" class="content w-100">
                ...
                <div data-v-7dd9989e="" class="help-scroll">
                    ...
                    <div data-v-7dd9989e="" class="item-helper">
                        <div data-v-7dd9989e="" class="title mb-2">TopViecLam hỗ trợ tư vấn tuyển dụng miễn phí, vui lòng chọn
                            link dưới để nhận sự trợ giúp.
                        </div>
                        <div data-v-7dd9989e="" class="text-muted small-text"><a data-v-7dd9989e=""
                                                                                 href="/app/support-box/service-consulting-survey"
                                                                                 class="text-primary font-weight-bold td-underline"
                        >
                            Tôi muốn được tư vấn về các gói đăng tin
                        </a></div>
                    </div>
                    <div data-v-7dd9989e="" class="item-helper">
                        <div data-v-7dd9989e="" class="title mb-2">Tài liệu hướng dẫn sử dụng</div>
                        <div data-v-7dd9989e="" class="text-muted small-text">
                            Tìm kiếm chi tiết những tính năng, hướng dẫn sử dụng tại&nbsp;
                            <a data-v-7dd9989e="" href="https://tuyendung.topvieclam.vn/help"
                               style="color: rgb(66, 133, 244);">https://tuyendung.TopViecLam.vn/help</a></div>
                    </div>
                </div>
            </div>
        </div>
