...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="<%=request.getContextPath()%>/business/assets/img/logo/logo.png">
    <link rel="icon" type="image/png" href="<%=request.getContextPath()%>/assets/img/logo/logo.png">
